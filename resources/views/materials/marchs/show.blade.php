    ...
    <div class="row col-12">
            ...
            <div class="card border-primary mb-3">
                <div class="card-header">
                    <h5 class="card-title">
                        ...
                        <i class="bi bi-bank2 me-1"></i> {{$march->title}}
                    </h5>
                </div>
                <div class="card-body shadow">
                    <table class="table table-light table-hover shadow">
                        <tbody>
                            <th class="align-content-center"> Modèles </th>
                            <td>
                                        ...
                                        <div class="row col-12 mt-2">
                                            <div class="col-4">
                                                ...
                                                <span class="badge badge-bg">
                                                    <a class="text-decoration-none" href="{{route('marchs.delivery', $delivery->id)}}">{{$delivery->model_material->title}}</a>
                                                </span>
                                            </div>
                                            <div class="col-4">
        ...
        <div class="col-4">
            <div class="card border-primary mb-3">
                ...
                <div class="card-body shadow">
                    <form action="{{route('marchs.affect', $march->id)}}" method="POST">
                        @csrf
    ...
    <div>
        <div class="card border-primary shadow mb-3">
            <div class="card-header border-primary">
                <div class="row col-12">
                    <div class="col-6">
                        <h5> Les matérieles du marché <span class="badge bg-light">{{$march->title}}</span></h5>
                    </div>
                    <div class="col-6">
                        <a href="{{route('marchs.export', $march->id)}}" class="text-decoration-none float-end" >
