        ...
        <div class="col-4">
            <div class="card border-primary shadow mb-3">
                <div class="card-header border-primary">
                    <h5>
                        <a href="{{route('types.index')}}" ><i class="bi bi-arrow-left-circle-fill text-primary"></i></a>
                        Type du matériel : {{$type->title}}
                    </h5>
                </div>
                <div class="card-body">
                    <ul class="list-group">
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            Nombre des modèles
                            <span class="badge bg-primary rounded-pill">{{count($type->models_material)}}</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
        ...
        <div class="col-8">
            <div class="card border-primary shadow mb-3">
                <div class="card-header border-primary">
                    <div class="row col-12">
                        <div class="col-6">
                            <h5> Les matériele du type <span class="badge bg-light">{{$type->title}}</span></h5>
                        </div>
                        <div class="col-6">
                            <a href="{{route('types.export', $type->id)}}" class="text-decoration-none float-end" >
