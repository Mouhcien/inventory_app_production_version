        ...
        <div class="col-6">
            <div class="card border-primary mb-3 shadow">
                <div class="card-header">
                    <h5 class="card-title">
                        <i class="bi bi-border-style me-1"></i> Les types du matériels
                    </h5>
                </div>
                    ...
                    <table class="table table-light table-striped table-hover shadow">
                        ...
                        @forelse($types as $type)
                            <tr>
                                ...
                                <td> {{ $type->title }}</td>
                                <td>
                                    <x-button-traitement href="{{route('types.edit', $type->id)}}" class="btn btn-sm btn-warning" icon="bi bi-pencil"  />
                                    <x-button-traitement href="{{route('types.show', $type->id)}}" class="btn btn-sm btn-info" icon="bi bi-list-columns"  />
                                    @if(config('app.delete') == true)
                    ...
                    <form action="{{route($url, $id)}}" method="POST">
                        ...
                        <div>
                            <x-input-text
                                ...
                                name="title"
                                class="form-control"
                                placeholder="Type du matériel informatique"
                                id="typeTitle"
