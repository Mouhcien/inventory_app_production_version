    ...
    <div class="card border-primary mb-3 shadow-lg">
        <div class="card-header border-primary shadow-lg">
            <div class="row col-12">
                <div class="col-6">
                    <h5>
                        <a href="{{route('cities.index')}}" ><i class="bi bi-arrow-left-circle-fill text-primary"></i></a>
                        <span class="badge bg-info" >Ville :</span>
                        <span class="badge bg-light">{{$city->title}}</span>
                    </h5>
                </div>
                <div class="col-6">
